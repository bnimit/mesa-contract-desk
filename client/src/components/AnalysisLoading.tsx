export function AnalysisLoading() {
  const branches = [
    { name: "fundamentals", color: "text-fundamentals", label: "Fundamental analysis" },
    { name: "sentiment", color: "text-sentiment", label: "Market sentiment" },
    { name: "technical", color: "text-technical", label: "Technical analysis" },
  ];
